...
dependencies {
    testImplementation(project(":scrapegraphai-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../scrapegraphai-java-core/src/main/resources/META-INF/proguard/scrapegraphai-java-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.scrapegraphai.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../scrapegraphai-java-core/src/main/resources/META-INF/proguard/scrapegraphai-java-core.pro",

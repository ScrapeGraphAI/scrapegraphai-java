...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.scrapegraphai.api.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.scrapegraphai.api.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.scrapegraphai.api.** {
    <init>(...);

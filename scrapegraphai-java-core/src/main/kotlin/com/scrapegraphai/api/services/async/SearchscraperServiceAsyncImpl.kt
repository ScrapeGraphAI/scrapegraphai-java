...
class SearchscraperServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    SearchscraperServiceAsync {

    private val withRawResponse: SearchscraperServiceAsync.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): SearchscraperServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): SearchscraperServiceAsync =
        SearchscraperServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())

    override fun create(
        params: SearchscraperCreateParams,
        requestOptions: RequestOptions,
    ): CompletableFuture<CompletedSearchScraper> =
        // post /searchscraper
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            SearchscraperServiceAsyncImpl.WithRawResponseImpl(
        ...
        override fun create(
            params: SearchscraperCreateParams,
            requestOptions: RequestOptions,
        ): CompletableFuture<HttpResponseFor<CompletedSearchScraper>> {
            val request =
                HttpRequest.builder()
        ...
        override fun retrieveStatus(
            params: SearchscraperRetrieveStatusParams,
            requestOptions: RequestOptions,
        ): CompletableFuture<HttpResponseFor<SearchscraperRetrieveStatusResponse>> {

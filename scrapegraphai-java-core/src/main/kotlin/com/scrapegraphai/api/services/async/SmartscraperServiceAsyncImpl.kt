...
class SmartscraperServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    SmartscraperServiceAsync {

    private val withRawResponse: SmartscraperServiceAsync.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): SmartscraperServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: Consumer<ClientOptions.Builder>): SmartscraperServiceAsync =
        SmartscraperServiceAsyncImpl(clientOptions.toBuilder().apply(modifier::accept).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            SmartscraperServiceAsyncImpl.WithRawResponseImpl(

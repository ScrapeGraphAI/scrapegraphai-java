...
private constructor(
    ...
    /** A builder for [CreditRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(creditRetrieveParams: CreditRetrieveParams) = apply {
            additionalHeaders = creditRetrieveParams.additionalHeaders.toBuilder()
            additionalQueryParams = creditRetrieveParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [CreditRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CreditRetrieveParams =
            CreditRetrieveParams(additionalHeaders.build(), additionalQueryParams.build())
    }

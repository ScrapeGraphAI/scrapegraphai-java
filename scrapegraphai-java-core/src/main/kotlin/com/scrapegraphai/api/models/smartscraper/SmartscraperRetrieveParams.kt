...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SmartscraperRetrieveParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [SmartscraperRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(smartscraperRetrieveParams: SmartscraperRetrieveParams) = apply {
            requestId = smartscraperRetrieveParams.requestId
            additionalHeaders = smartscraperRetrieveParams.additionalHeaders.toBuilder()
            additionalQueryParams = smartscraperRetrieveParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [SmartscraperRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): SmartscraperRetrieveParams =
            SmartscraperRetrieveParams(
                requestId,

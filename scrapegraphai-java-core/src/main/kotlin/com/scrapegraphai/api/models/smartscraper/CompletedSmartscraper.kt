...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [CompletedSmartscraper]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CompletedSmartscraper]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(completedSmartscraper: CompletedSmartscraper) = apply {
            error = completedSmartscraper.error
            requestId = completedSmartscraper.requestId
            result = completedSmartscraper.result
            status = completedSmartscraper.status
            userPrompt = completedSmartscraper.userPrompt
            websiteUrl = completedSmartscraper.websiteUrl
            additionalProperties = completedSmartscraper.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CompletedSmartscraper].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CompletedSmartscraper =
    ...
    fun validate(): CompletedSmartscraper = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "CompletedSmartscraper{error=$error, requestId=$requestId, result=$result, status=$status, userPrompt=$userPrompt, websiteUrl=$websiteUrl, additionalProperties=$additionalProperties}"
}

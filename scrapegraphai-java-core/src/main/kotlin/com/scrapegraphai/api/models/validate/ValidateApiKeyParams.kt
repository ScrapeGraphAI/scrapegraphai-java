...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ValidateApiKeyParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ValidateApiKeyParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(validateApiKeyParams: ValidateApiKeyParams) = apply {
            additionalHeaders = validateApiKeyParams.additionalHeaders.toBuilder()
            additionalQueryParams = validateApiKeyParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ValidateApiKeyParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ValidateApiKeyParams =
            ValidateApiKeyParams(additionalHeaders.build(), additionalQueryParams.build())
    }

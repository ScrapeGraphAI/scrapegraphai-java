...
class CrawlRetrieveResultsParams
private constructor(
    ...
    /** A builder for [CrawlRetrieveResultsParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(crawlRetrieveResultsParams: CrawlRetrieveResultsParams) = apply {
            taskId = crawlRetrieveResultsParams.taskId
            additionalHeaders = crawlRetrieveResultsParams.additionalHeaders.toBuilder()
            additionalQueryParams = crawlRetrieveResultsParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [CrawlRetrieveResultsParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CrawlRetrieveResultsParams =
            CrawlRetrieveResultsParams(
                taskId,

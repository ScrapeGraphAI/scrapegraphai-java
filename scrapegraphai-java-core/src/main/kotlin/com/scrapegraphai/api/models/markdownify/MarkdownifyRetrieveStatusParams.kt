...
class MarkdownifyRetrieveStatusParams
private constructor(
    ...
    companion object {
         ...
         * [MarkdownifyRetrieveStatusParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [MarkdownifyRetrieveStatusParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(markdownifyRetrieveStatusParams: MarkdownifyRetrieveStatusParams) =
            apply {
                requestId = markdownifyRetrieveStatusParams.requestId
                additionalHeaders = markdownifyRetrieveStatusParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    markdownifyRetrieveStatusParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [MarkdownifyRetrieveStatusParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): MarkdownifyRetrieveStatusParams =
            MarkdownifyRetrieveStatusParams(
                requestId,

...
private constructor(
    ...
    /** A builder for [HealthzCheckParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(healthzCheckParams: HealthzCheckParams) = apply {
            additionalHeaders = healthzCheckParams.additionalHeaders.toBuilder()
            additionalQueryParams = healthzCheckParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [HealthzCheckParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): HealthzCheckParams =
            HealthzCheckParams(additionalHeaders.build(), additionalQueryParams.build())
    }
